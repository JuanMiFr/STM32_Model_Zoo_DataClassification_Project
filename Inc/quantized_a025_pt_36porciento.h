/**
  ******************************************************************************
  * @file    quantized_a025_pt_36porciento.h
  ...
  ******************************************************************************
  */
#ifndef AI_QUANTIZED_A025_PT_36PORCIENTO_H
#define AI_QUANTIZED_A025_PT_36PORCIENTO_H

#include "quantized_a025_pt_36porciento_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_QUANTIZED_A025_PT_36PORCIENTO_MODEL_NAME          "quantized_a025_pt_36porciento"
#define AI_QUANTIZED_A025_PT_36PORCIENTO_ORIGIN_MODEL_NAME   "mobilenet_a025_pt_int8"

/******************************************************************************/
#define AI_QUANTIZED_A025_PT_36PORCIENTO_ACTIVATIONS_ALIGNMENT   (4)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_INPUTS_IN_ACTIVATIONS   (4)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_NUM        (1)

AI_DEPRECATED
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN \
  ai_quantized_a025_pt_36porciento_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_SIZE { \
  AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_SIZE, \
}
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_SIZE_BYTES { \
  AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_SIZE_BYTES, \
}
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_HEIGHT      (224)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_WIDTH       (3)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_CHANNEL     (224)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_SIZE        (150528)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_IN_1_SIZE_BYTES  (150528)

/******************************************************************************/
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_NUM       (1)

AI_DEPRECATED
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT \
  ai_quantized_a025_pt_36porciento_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_SIZE { \
  AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_1_SIZE, \
}
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_SIZE_BYTES { \
  AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_1_SIZE_BYTES, \
}
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_1_CHANNEL     (100)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_1_SIZE        (100)
#define AI_QUANTIZED_A025_PT_36PORCIENTO_OUT_1_SIZE_BYTES  (100)

/******************************************************************************/
#define AI_QUANTIZED_A025_PT_36PORCIENTO_N_NODES (30)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup quantized_a025_pt_36porciento
 ...
 * @ingroup quantized_a025_pt_36porciento
 ...
 * @ref ai_quantized_a025_pt_36porciento_create. Both the activations memory buffer 
 ...
 * using @ref ai_quantized_a025_pt_36porciento_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_quantized_a025_pt_36porciento_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_quantized_a025_pt_36porciento_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_QUANTIZED_A025_PT_36PORCIENTO_*
 * defines into file @ref quantized_a025_pt_36porciento.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_quantized_a025_pt_36porciento_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_QUANTIZED_A025_PT_36PORCIENTO_H */
